import {
  ...
  export default function Form1CreateStudent(props) {
    ...
    const [items, setItems] = useState([
      { label: 'Sinh viên', value: '0' },
      { label: 'Trưởng CLB', value: '1' },
      { label: 'Bí thư', value: '2' }
    ]);

    // role id này để chuyển value từ 1, 2 thành 2 (vì trưởng clb, bí thư)
    // cùng cấp và role_id của sv là 1
