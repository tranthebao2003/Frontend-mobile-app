...
import StudentRegisterItemTruongCLB from "./StudentRegisterItemTruongCLB";
...
export default function ListStudentRegisterTruongCLB(props) {
  const{navigation} = props
  const {
    // này là id_act để lấy ra register
    id,
    act_name,
  } = props.route.params.listStudentRegisterTruongCLB;
      ...
      >
        ...
        >
          ...
          <FlatList
            ...
            data={resigter}
            renderItem={({ item }) => (
              <StudentRegisterItemTruongCLB
              studentRegisterItemTruongCLB={item}
                onPressItem={() => {
                  navigation.navigate("detailStudentRegisterTruongCLB", {
                    detailStudentRegisterTruongCLB: item,
                  });
                }}
              />
            )}
