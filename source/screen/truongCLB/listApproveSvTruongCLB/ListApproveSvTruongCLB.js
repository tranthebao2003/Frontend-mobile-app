import {
  ...
  export default function ListApproveSvTruongCLB({ navigation }) {
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <ApproveSvItemTruongCLB
                  approveSvTruongCLB={item}
                  onPressItem={() => {
                    navigation.navigate("detailApproveSvTruongCLB", {
                      detailApproveSvTruongCLB: item,
                    });
                  }}
                />
              )}
