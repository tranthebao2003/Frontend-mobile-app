import {
  ...
  export default function From2EditActiveDoanTruong(props) {
    ...
    const {
        ...
        organizerFromForm1,
        costFromForm1,
        descriptionFromForm1
      } = props.route.params;
  
    const [location, setLocation] = useState(locationFromForm1);
  
    const [organizer, setOrganizer] = useState(organizerFromForm1);
    ...
    const [cost, setCost] = useState(`${costFromForm1}`);
  
    const [description, setDescription] = useState(descriptionFromForm1);
